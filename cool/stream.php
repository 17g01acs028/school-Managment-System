    ...
    <a href="logout.php" style="text-align:center; background-color:#65798b">Log out</a>
     ...
     <br>
            ...
            <div class="row" id="ceck">
                <div class="col">
                        <h2><a href="index.php">Dashboard</a>/Streams</h2>
                ...
                <div class="col">
                        <div class="row" id="rk" style="margin: 10px; color: ivory; text-align: center;">
                                <div class="col" id="col" style="width:80%; padding: 10px; background-color: #11c26d;background-color: #11c26d; border-right: 2px solid green;">
                                       ...
                                       <button onclick="printIt(document.getElementById('table').innerHTML)" ><small>Print</small> </button>
                                </div>
...
<a href="stream.php">   <span onclick="document.getElementById('id02').style.display='none'" class="close" title="Close Modal">&times;</span></a> 
   <!-- Material form login -->
  <div id="prod">
<div class="card">
  ...
  <div id="res">
     ...
     <form action="post">
       ...
       <div id="btnsub">
         <button id="op1"  class="add" onclick="return false" onmousedown="add2();" style="background-color: #11c26d;color:white;margin-right:20px;width:100px;border-radius:30px;text-align:center;padding:0px;height:40px">Register</button>
